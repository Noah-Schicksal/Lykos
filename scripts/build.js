...
if (fs.existsSync(path.join(publicSrc, 'index.html'))) {
    fs.copyFileSync(path.join(publicSrc, 'index.html'), path.join(publicDist, 'index.html'));
}
...
copyComponentStyles(path.join(publicSrc, 'ts/components'), path.join(publicJsDist, 'components'));
